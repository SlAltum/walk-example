...
func NewImageViewerMainWindow() *MainWindow {
	mw := new(ImageViewerMainWindow)
	var openAction *walk.Action

	imageViewerMw := MainWindow{
	...
	return &imageViewerMw
}

type ImageViewerMainWindow struct {
	*walk.MainWindow
	tabWidget    *walk.TabWidget
	prevFilePath string
}

func (mw *ImageViewerMainWindow) openAction_Triggered() {
	if err := mw.openImage(); err != nil {
		log.Print(err)
	}
}

func (mw *ImageViewerMainWindow) openImage() error {
...
func (mw *ImageViewerMainWindow) aboutAction_Triggered() {
